...
namespace Application.Interfaces
{
    public interface IApplicationSignInManager
    {
        ...
        /// <summary>
        /// The <see cref="UserManager{AppUser}"/> used.
        /// </summary>
        UserManager<AppUser> UserManager { get; set; }

        /// <summary>
        /// The <see cref="IUserClaimsPrincipalFactory{AppUser}"/> used.
        /// </summary>
        IUserClaimsPrincipalFactory<AppUser> ClaimsFactory { get; set; }
        ...
        Task<ClaimsPrincipal> CreateUserPrincipalAsync(AppUser user);
        ...
        /// </returns>
        Task<bool> CanSignInAsync(AppUser user);
        ...
        /// <param name="authenticationMethod">Name of the method used to authenticate the user.</param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        Task SignInAsync(AppUser user, Microsoft.AspNetCore.Authentication.AuthenticationProperties authenticationProperties, string authenticationMethod = null);
        ...
        /// <returns>The task object representing the asynchronous operation. The task will contain the <typeparamref name="AppUser"/>
        /// if the stamp matches the persisted value, otherwise it will return false.</returns>
        Task<AppUser> ValidateSecurityStampAsync(ClaimsPrincipal principal);
        ...
        Task<SignInResult> PasswordSignInAsync(AppUser user, string password,
        ...
        /// <returns>The task object representing the asynchronous operation.</returns>
        Task RememberTwoFactorClientAsync(AppUser user);
        ...
        /// <summary>
        /// Gets the <typeparamref name="AppUser"/> for the current two factor authentication login, as an asynchronous operation.
        /// </summary>
        /// <returns>The task object representing the asynchronous operation containing the <typeparamref name="AppUser"/>
        /// for the sign-in attempt.</returns>
        ...
        Task<SignInResult> SignInOrTwoFactorAsync(AppUser user, bool isPersistent, string loginProvider = null, bool bypassTwoFactor = false);
        ...
        Task<SignInResult> LockedOut(AppUser user);
        ...
        Task<SignInResult> PreSignInCheck(AppUser user);
        ...
        /// <param name="user">The user</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/> of the operation.</returns>
        Task ResetLockout(AppUser user);
        ...
        /// if the stamp matches the persisted value, otherwise it will return false.</returns>
        Task<AppUser> ValidateCurrentUserSecurityStampAsync();
