...
namespace Application.Interfaces
{
    public interface IApplicationUserStore
    {
        ...
        Task<UserRole> FindUserRoleAsync(string userId, string roleId, CancellationToken cancellationToken);
        ...
        Task<AppUser> FindUserAsync(string userId, CancellationToken cancellationToken);
        ...
        Task<UserLogin> FindUserLoginAsync(string userId, string loginProvider, string providerKey, CancellationToken cancellationToken);
        ...
        Task<UserToken> FindTokenAsync(AppUser user, string loginProvider, string name, CancellationToken cancellationToken);
