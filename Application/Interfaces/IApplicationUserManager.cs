...
namespace Application.Interfaces
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// <summary>
        /// Returns the AppUser ID claim value if present otherwise returns null.
        /// </summary>
        /// <param name="principal">The <see cref="ClaimsPrincipal"/> instance.</param>
        /// <returns>The AppUser ID claim value, or null if the claim is not present.</returns>
        /// <remarks>The AppUser ID claim is identified by <see cref="ClaimTypes.NameIdentifier"/>.</remarks>
        ...
        /// <summary>
        /// Returns the current AppUser ID claim value if present otherwise returns null.
        /// </summary>
        /// <returns>The current AppUser ID claim value, or null if the claim is not present.</returns>
        ...
        Task<byte[]> GetEmailImageAsync(string userId);



        Task<AppUser> FindByIdIncludeUserRolesAsync(string userId);

        Task<IdentityResult> UpdateUserAndSecurityStampAsync(string userId, Action<AppUser> action);

        Task<IdentityResult> AddOrUpdateUserRolesAsync(string userId, IList<string> selectedRoleIds, Action<AppUser> action = null);
