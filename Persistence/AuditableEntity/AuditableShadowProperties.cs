...
namespace Persistence.AuditableEntity
{
    ...
    public static class AuditableShadowProperties
    {
        ...
        public static void SetAddedShadowProperties(this EntityEntry<IAuditableEntity> addedEntry, AppShadowProperties props)
        {
            ...
            if (!string.IsNullOrEmpty(props.UserId)) addedEntry.Property(CreatedByUserId).CurrentValue = props.UserId;
        }
        ...
        public static void SetModifiedShadowProperties(this EntityEntry<IAuditableEntity> modifiedEntry, AppShadowProperties props)
        {
            ...
            if (!string.IsNullOrEmpty(props.UserId)) modifiedEntry.Property(ModifiedByUserId).CurrentValue = props.UserId;
        }
        ...
        private static string getUserId(this HttpContext httpContext)
        {
            string userId = null;
